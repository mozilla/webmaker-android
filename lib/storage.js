...
Store.prototype._createAppRef = function (id, fbRef, data) {
    ...
    App.prototype.update = function (properties, callback) {
        var self = this;
        self.firebase.update(properties, callback);
    };

    App.prototype.updateBlock = function (id, properties, callback) {
        var self = this;
        self.firebase.child('blocks/' + id).update(properties, callback);
    };
    ...
    App.prototype.remove = function (blockIndex, callback) {
        var self = this;
        var ref = self.firebase.child('blocks');
        ...
        ref.once('value', function (snapshot) {
            ...
            ref.set(blocks, callback);
        });
    };

    App.prototype.removeApp = function (callback) {
        var self = this;
        self.firebase.remove(callback);
...
Store.prototype.createApp = function createApp(options, callback) {
    var self = this;
    var templateId;
    options = options || {};
    ...
    var ref = _firebase.push(app, callback);
    var key = ref.key();
