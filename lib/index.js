...
var app = new Vue({
    ...
    ready: function () {
        ...
        this.$on('sideMenuShareClick', function (event) {
            this.$broadcast('sideMenuShareClick', event);
        });

        this.$on('sideMenuDataClick', function (event) {
            this.$broadcast('sideMenuDataClick', event);
        });
